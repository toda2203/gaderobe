...
export default function AppLayout() {
  ...
  const appIcon = '/assets/garderobe.png';

  // Load logo from localStorage
  useEffect(() => {
    const savedLogo = localStorage.getItem('company_logo');
    if (savedLogo) {
      const isOldLogo = savedLogo.includes('/assets/transparent.png') || savedLogo.includes('/assets/kreis.png');
      if (isOldLogo) {
        localStorage.setItem('company_logo', appIcon);
        setLogoUrl(appIcon);
        return;
      }
    }
