...
import { RestoreAutomaticBackup } from '@components/Settings/RestoreAutomaticBackup';
...
export default function Settings() {
  ...
  useEffect(() => {
    ...
    console.log('[SETTINGS] Calling loadEmailMode');
    loadEmailMode();
    if (user) {
      fetchStats();
    }
  ...
  // Load email mode configuration (Read-Only)
            ...
            items={[
              {
                ...
                label: (
                  <Space>
                    <DownloadOutlined />
                    <Text strong>Daten exportieren (Backup erstellen)</Text>
                  </Space>
                ),
                children: (
                  <>
              ...
              },
              {
                ...
                label: (
                  <Space>
                    <UploadOutlined />
                    <Text strong>Daten importieren (Backup wiederherstellen)</Text>
                  </Space>
                ),
                children: (
                  <>
              ...
              },
              {
                ...
                label: (
                  <Space>
                    <DatabaseOutlined />
                    <Text strong>Automatisches Backup wiederherstellen</Text>
                  </Space>
                ),
                children: <RestoreAutomaticBackup />,
              },
              {
                key: 'auto-config',
                label: (
                  <Space>
                    <ClockCircleOutlined />
                    <Text strong>Backup-Zeitpläne konfigurieren</Text>
                  </Space>
                ),
                children: <AutomaticBackupConfig />,
              },
            ]}
          />
        </>
              ...
              <div>
                <Collapse
                  items={[
                    {
                      key: 'email-mode',
                      label: 'Email-Modus (Nur-Ansicht)',
                      children: (
                        <Space direction="vertical" size="large" style={{ width: '100%' }}>
                          <Alert
                            type="info"
                            message="Konfiguration über .env Datei"
                            description="Der Email-Modus wird über die .env Datei konfiguriert (EMAIL_MODE und TEST_EMAIL_ADDRESS) und kann nur dort geändert werden."
                            showIcon
                            style={{ marginBottom: 16 }}
                          />
                          ...
                          <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                            ...
                            <Tag color={emailMode === 'production' ? 'success' : 'warning'} style={{ fontSize: 14, padding: '4px 12px' }}>
                              {emailMode === 'production' ? '✓ Produktionsmodus' : '⚠ Entwicklungsmodus'}
                            </Tag>
                          </div>
                            ...
                            <Alert
                              ...
                              description={
                                <div>
                                  ...
                                  <Text strong code style={{ fontSize: 14, marginTop: 8, display: 'inline-block' }}>
                                    {testAddress}
                                  </Text>
                                </div>
                              }
